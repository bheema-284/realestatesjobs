        ...
        >
            <div className="w-full sm:w-[85%] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 z-50">
                ...
                <div className="col-span-1">
                    ...
                    <ul className="space-y-2 text-md font-light w-full sm:w-20">
                ...
                <div className="col-span-1">
                    ...
                    <ul className="space-y-2 text-md font-light w-full sm:w-40">
                        {/* Iterate over jobCategories and use the onClick handler */}
                        {jobCategories.map((category) => (
                            <li key={category}>
                                <button
                                    onClick={() => handleCategoryClick(category)}
                                    className="text-md font-light p-0 border-none bg-transparent text-left w-full hover:text-orange-400 transition-colors duration-300"
                                >
                                    {category}
                                </button>
                            </li>
                ...
                <div className="col-span-1 mb-4">
                    ...
                    <address className="not-italic text-md font-light space-y-2">
                        <p>
            ...
            {/* Bottom Section */}
            <div
                className="p-5 my-8 w-full sm:w-[85%] mx-auto rounded-lg text-center text-md font-light flex flex-col md:flex-row justify-between items-center"
