...
export default function CompanyDetails({ userData, isLoading, error, userId }) {
    ...
    return (
        <>
            {error ? <div className="text-md text-gray-900 flex justify-center items-center mt-32">No Data Available</div> :
